      ...
      <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }} className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a] border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-20">
            {/* Mobile: Center logo absolutely, Desktop: Normal layout */}
            <motion.a href="#" className="flex items-center mx-auto md:mx-0 md:absolute md:left-1/2 md:-translate-x-1/2" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
