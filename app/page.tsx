        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 relative">
            <motion.a href="#" className="flex items-center" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <img src="/logo.svg" alt="Auto Spa 1 Logo" className="h-12 sm:h-14 w-auto object-contain brightness-125 contrast-125" />
            </motion.a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 mb-8 sm:mb-12">
            <div className="col-span-2">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <img src="/logo.svg" alt="Auto Spa 1 Logo" className="h-10 sm:h-12 w-auto object-contain brightness-125 contrast-125" />
              </div>
