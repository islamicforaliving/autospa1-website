        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-center md:grid md:grid-cols-3">
            ...
            <motion.a href="#" className="flex items-center" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <img src="/logo.png" alt="Auto Spa 1 Logo" className="h-28 sm:h-36 w-auto max-w-none object-contain" />
            </motion.a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 mb-8 sm:mb-12">
            <div className="col-span-2">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <img src="/logo.png" alt="Auto Spa 1 Logo" className="h-20 sm:h-24 w-auto max-w-none object-contain" />
              </div>
